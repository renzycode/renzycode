  ...
  <div className="lg:flex justify-center lg:mt-16">
    <div className="lg:basis-2/3 lg:mt-10">
      <div className="text-center p-10">
        <h2 className="text-5xl py-2 dark:text-my-white-blue  text-black font-medium">
          RENZY JOHN MINERVA
        </h2>
      ...
      <div className="text-5xl flex justify-center gap-16 py-2 text-gray-900">
        <AiFillFacebook className="dark:bg-my-dark-blue  dark:text-black p-0.1 rounded" />
        <AiFillGithub className=" dark:bg-my-dark-blue  dark:text-black p-0.1 rounded" />
        <AiFillYoutube className="bg-gradient-to-br dark:bg-my-dark-blue dark:to-green-900 to-blue-400 dark:text-black p-0.1 rounded" />
      </div>
    </div>
    ...
    <div className="lg:basis-1/3 mx-auto relative rounded-full w-80 h-80 my-10">
      <Image
        src={MyProfile}
        className="rounded-full bg-gradient-to-br dark:from-my-white-blue dark:to-black from-green-200 to-blue-400"
        alt="profile"
      />
    </div>
  </div>
