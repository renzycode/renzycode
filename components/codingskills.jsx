...
const CodingSkills = () => {
  return (
    <section className="py-5">
      <div className="dark:bg-my-dark-blue bg-white p-10 rounded-xl bg-opacity-40 dark:bg-opacity-40">
        ...
        <p className="text-md py-2 leading-6 dark:text-gray-400 text-gray-600">
          ...
          <span className="dark:text-my-dark-blue text-blue-500">learned</span> or{" "}
          <span className="dark:text-my-dark-blue text-blue-500">experienced</span>{" "}
          in that programming language or web technologies.
        </p>
      </div>
      <div className="text-center shadow-xl p-10 rounded-xl my-10 bg-white dark:bg-my-dark-blue dark:bg-opacity-40 flex-2">
